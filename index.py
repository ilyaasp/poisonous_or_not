...
def main():
    ...
    st.sidebar.subheader("Before you start classify, take sometime to look at and understand your data")
    ...
    st.sidebar.title("Start Classification")
    st.sidebar.subheader("1. Choose classifier")
    classifier = st.sidebar.selectbox("Classifier", ("Support Vector Machine (SVM)", "Logistic Regression", "Random Forest"))
    
    if classifier == 'Support Vector Machine (SVM)':
        st.sidebar.subheader("2. Choose The Right Hyperparameters")
        ...
        st.sidebar.subheader("3. Press Classify Button")
...
hide_streamlit_style = """
            ...
            footer:after {
            	content:'Made with love by Ilyas Perlindungan'; 
            	visibility: visible;
            	display: block;
                font-weight: bold;
            	position: relative;
